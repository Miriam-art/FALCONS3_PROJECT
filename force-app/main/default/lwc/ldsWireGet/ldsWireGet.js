...
export default class LdsWireGet extends LightningElement {
    ...
    @wire(getPicklistValues, { recordTypeId: '0125e000000RxFvAAK', fieldApiName: COUNTRY_FIELD })
    ...
    //Below is for World recordType - replace the record type Id from your salesforce org
    @wire(getPicklistValues, { recordTypeId: '0125e000000RxFvAAK', fieldApiName: STATE_FIELD })
    ...
    //Below is for World recordType - replace the record type Id from your salesforce org
    @wire(getPicklistValues, { recordTypeId: '0125e000000RxFvAAK', fieldApiName: CITY_FIELD })
    ...
    //Below is for World recordType - replace the record type Id from your salesforce org
    @wire(getPicklistValuesByRecordType, { objectApiName: ACCOUNT_OBJECT, recordTypeId: '0125e000000RxFvAAK' })
    getCityPicklist({ data, error }) {
        if (data) {
